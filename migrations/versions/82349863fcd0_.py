...
Revision ID: 82349863fcd0
Revises: 
Create Date: 2024-03-20 12:34:09.118436
...
def upgrade():
    ...
    sa.Column('category', sa.Enum('Appetizer', 'Entree', 'Drink', 'Dessert', 'Special', name='category'), nullable=False),
